...
# $VNC_PORT $VNC_PW $NO_VNC_PORT need to be set before running this script
...
if [ $NO_VNC_PORT ]; then
    ...
    websockify -D --web=$VNC_ROOT/novnc $NO_VNC_PORT localhost:$VNC_PORT &> $LOG_FILE_DIR/${LOG_FILE_PREFIX}_no_vnc_startup.log & 
