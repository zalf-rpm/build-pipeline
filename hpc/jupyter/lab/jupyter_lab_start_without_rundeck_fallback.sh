...
USER=user # enter your hpc username here
LOGIN_HOST=mycluster.de # enter cluster hostname here, e.g. login.cluster.domain.de
TIME=09:00:00 # d-hh:mm:ss
PARTITION=gpu-Tesla-V100
VERSION=noconda_p3.12_1
PORT=8888 # local port for ssh tunnel
